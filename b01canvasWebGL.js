...
var ngl = new function (){
	...
	var texturesList = [];
	this.createTexture = function( idx ){
		var texture = gl.createTexture();
		texturesList[ idx ] = texture;
	};
	
	var gpuTexturesRefList = [ "TEXTURE0", "TEXTURE1", "TEXTURE2", "TEXTURE3", "TEXTURE4", "TEXTURE5", "TEXTURE6", "TEXTURE7", "TEXTURE8", "TEXTURE9", "TEXTURE10" ];
	this.loadImageTexture = function(image, name, textureUnit, idx ){
		// Create a texture.
		gl.bindTexture( gl.TEXTURE_2D, texturesList[ idx ] );
	...
	this.loadDataTexture = function(pixeldata, width, height, name, textureUnit, idx ){
		// Create a texture.
		gl.bindTexture( gl.TEXTURE_2D, texturesList[ idx ] );
